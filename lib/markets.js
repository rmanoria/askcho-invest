...
const EXTRA_INDICES_RAW = [
  { name: "Dow Jones", region: "America", seed: 511, base: 42150.6, vol: 0.007 },
  { name: "S&P 500", region: "America", seed: 512, base: 6015.3, vol: 0.007 },
...
export const ALL_INDICES = [
  ...INDEXES.map((ix) => ({ ...ix, region: ix.name.indexOf("NGX") === 0 ? "Africa" : "America" })),
...
export const BONDS = withHistoryValue([
  ...
  { ticker: "US10Y", name: "US 10-Year Treasury Yield", type: "America", currency: "%", price: 4.32, seed: 902, vol: 0.008 },
