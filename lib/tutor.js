...
export function getTutorReply(input) {
  ...
  if (hit) return hit.a;
  return "I don't have an explanation for that yet \u2014 try asking about P/E ratio, diversification, dividends, ETFs, limit orders, treasury bills, or auto-invest. Tap a topic chip below to get started.";
}
